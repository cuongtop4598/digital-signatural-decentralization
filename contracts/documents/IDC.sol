...
interface IDC {
    /**
     */
    function storeUser(string memory userID, bytes memory infoSignature, address publicKey) external returns (bool);
    ...
    /**
     */
    function verifyUserInfo(string memory userID, bytes32 digest) external returns (bool);
